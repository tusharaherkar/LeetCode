...
// In the binary number system, the expression n & (n-1) is significant because it efficiently eliminates the least significant bit (LSB) set to 1 in the binary representation of n. This property is useful in various applications, including counting set bits, determining if a number is a power of 2, and bit manipulation tasks. 
...
// 4. Bit Manipulation Tasks:
// • The n & (n-1) operation can be used to isolate specific bits or groups of bits in a binary number.
// • By repeatedly applying this operation, you can efficiently manipulate bits in a binary representation. 
